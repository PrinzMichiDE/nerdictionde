...
export const mediadatenTranslations: Record<string, MediadatenTranslations> = {
  ...
  hi: {
    ...
    timeline: {
      title: "12 महीने की समय-रेखा",
      subtitle: "पिछले 12 महीनों में मासिक आगंतुकों और पृष्ठ दृश्यों का विकास",
      monthlyVisitors: "मासिक आगंतुक",
      pageViews: "पृष्ठ दृश्य",
      max: "अधिकतम:",
    },
  ...
  es: {
    ...
    contact: {
      title: "Contacto",
      subtitle: "Para colaboraciones y consultas",
      general: "General:",
      forGames: "Para juegos:",
      forHardware: "Hardware:",
      forMovies: "Películas y Series:",
    },
    technical: {
  ...
  fr: {
    ...
    contact: {
      title: "Contact",
      subtitle: "Pour les collaborations et les demandes",
      general: "Général:",
      forGames: "Pour les jeux:",
      forHardware: "Hardware:",
      forMovies: "Films et Séries:",
    },
    technical: {
  ...
  ar: {
    ...
    contact: {
      title: "جهة الاتصال",
      subtitle: "للتعاون والاستفسارات",
      general: "عام:",
      forGames: "للألعاب:",
      forHardware: "الأجهزة:",
      forMovies: "الأفلام والمسلسلات:",
    },
    technical: {
  ...
  bn: {
    ...
    detailedMetrics: { title: "বিস্তারিত মেট্রিক্স", subtitle: "ব্যবহারকারী আচরণ এবং পৌঁছানো সম্পর্কে অতিরিক্ত অন্তর্দৃষ্টি", pagesPerVisit: "প্রতি ভিজিটে পৃষ্ঠা", newVisitors: "নতুন দর্শক", returningVisitors: "ফিরে আসা দর্শক", reviewReadTime: "রিভিউ পড়ার সময়", firstTimeVisitors: "প্রথমবার দর্শক", loyalReadership: "বিশ্বস্ত পাঠক", average: "গড়" },
    timeline: { title: "12 মাসের টাইমলাইন", subtitle: "গত 12 মাসে মাসিক দর্শক এবং পৃষ্ঠা ভিউর বিকাশ", monthlyVisitors: "মাসিক দর্শক", pageViews: "পৃষ্ঠা ভিউ", max: "সর্বোচ্চ:" },
  ...
  pt: {
    ...
    detailedMetrics: { title: "Métricas detalhadas", subtitle: "Mais informações sobre o comportamento do usuário e alcance", pagesPerVisit: "Páginas por visita", newVisitors: "Novos visitantes", returningVisitors: "Visitantes recorrentes", reviewReadTime: "Tempo de leitura da revisão", firstTimeVisitors: "Visitantes pela primeira vez", loyalReadership: "Leitores fiéis", average: "Média" },
  ...
  ja: {
    ...
    detailedMetrics: { title: "詳細指標", subtitle: "ユーザー行動とリーチに関する追加の洞察", pagesPerVisit: "訪問あたりのページ数", newVisitors: "新規訪問者", returningVisitors: "リピーター", reviewReadTime: "レビュー読了時間", firstTimeVisitors: "初回訪問者", loyalReadership: "忠実な読者層", average: "平均" },
  ...
  pa: {
    ...
    detailedMetrics: { title: "ਵਿਸਤ੍ਰਿਤ ਮੈਟ੍ਰਿਕਸ", subtitle: "ਉਪਭੋਗਤਾ ਵਿਵਹਾਰ ਅਤੇ ਪਹੁੰਚ ਬਾਰੇ ਵਾਧੂ ਸੂਝ", pagesPerVisit: "ਪ੍ਰਤੀ ਯਾਤਰਾ ਪੰਨੇ", newVisitors: "ਨਵੇਂ ਵਿਜ਼ਿਟਰ", returningVisitors: "ਵਾਪਸ ਆਉਣ ਵਾਲੇ ਵਿਜ਼ਿਟਰ", reviewReadTime: "ਸਮੀਖਿਆ ਪੜ੍ਹਨ ਦਾ ਸਮਾਂ", firstTimeVisitors: "ਪਹਿਲੀ ਵਾਰ ਵਿਜ਼ਿਟਰ", loyalReadership: "ਵਫ਼ਾਦਾਰ ਪਾਠਕ", average: "ਔਸਤ" },
  ...
  jv: {
    ...
    detailedMetrics: { title: "Metrik Rinci", subtitle: "Wawasan tambahan babagan prilaku panganggo lan jangkauan", pagesPerVisit: "Kaca saben Kunjungan", newVisitors: "Pengunjung Anyar", returningVisitors: "Pengunjung Balik", reviewReadTime: "Wektu Maca Review", firstTimeVisitors: "Pengunjung Pisanan", loyalReadership: "Pembaca Setia", average: "Rata-rata" },
  ...
  wuu: {
    ...
    detailedMetrics: { title: "详细指标", subtitle: "用户行为和覆盖范围的进一步洞察", pagesPerVisit: "每次访问页面数", newVisitors: "新访客", returningVisitors: "回访访客", reviewReadTime: "评测阅读时间", firstTimeVisitors: "首次访客", loyalReadership: "忠实读者群", average: "平均" },
  ...
  id: {
    ...
    detailedMetrics: { title: "Metrik Terperinci", subtitle: "Wawasan tambahan tentang perilaku pengguna dan jangkauan", pagesPerVisit: "Halaman per Kunjungan", newVisitors: "Pengunjung Baru", returningVisitors: "Pengunjung Kembali", reviewReadTime: "Waktu Membaca Ulasan", firstTimeVisitors: "Pengunjung Pertama Kali", loyalReadership: "Pembaca Setia", average: "Rata-rata" },
